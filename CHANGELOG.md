...
* **nav:** Cline first-run + Golden Path route stack model ([#85](https://github.com/edwardlthompson/agent-project-bootstrap/issues/85)) ([4734a35](https://github.com/edwardlthompson/agent-project-bootstrap/commit/4734a35894870afdea580965be257035e23a2b6b))
...
* **android:** keep Venmo donate under Settings → About ([#90](https://github.com/edwardlthompson/agent-project-bootstrap/issues/90)) ([9cfa1e8](https://github.com/edwardlthompson/agent-project-bootstrap/commit/9cfa1e819acd11a9ba9956a82a1d5edb65d509a5))
...
* **ci:** Settings→About e2e + Android donate UI test compile ([#92](https://github.com/edwardlthompson/agent-project-bootstrap/issues/92)) ([4e2dc1c](https://github.com/edwardlthompson/agent-project-bootstrap/commit/4e2dc1c107e23f6bb06a489f48103d8c683d9564))
...
* **deps:** override undici to close Dependabot CVE alerts ([e1e9790](https://github.com/edwardlthompson/agent-project-bootstrap/commit/e1e9790c16fd0c95cbf25d056d9c6f8bff59cf61))
...
* sync template version files to 0.11.0 for release PR ([5fe0fc1](https://github.com/edwardlthompson/agent-project-bootstrap/commit/5fe0fc1f0359238f9884b32c519496ba9d59e990))
